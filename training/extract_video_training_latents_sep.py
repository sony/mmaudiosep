...
from mmaudiosep.data.data_setup import error_avoidance_collate
from mmaudiosep.data.extraction.vgg_sound import VGGSound
...
data_cfg = {
    ...
    #    'subset_name': './sets/vgg-train.tsv',
    #    'normalize_audio': True,
    #},
    #'val': {
    #    'root': '../dataset/vggsound/video/',
    #    'subset_name': './sets/vgg-val.tsv',
    #    'normalize_audio': False,
    #},
    #'test': {
    #    'root': '../dataset/vggsound/video/',
    #    'subset_name': './sets/vgg-test.tsv',
    #    'normalize_audio': False,
    #},
}
...
def setup_dataset(split: str, output_audio_dir: Path):
    dataset = VGGSound(
        data_cfg[split]['root'],
        audio_output=f'{output_audio_dir}/audio-{mode}/vgg-{split}/', # [TODO]
...
def extract():
    ...
    parser.add_argument('--output_dir', type=Path,
                        default='./training/example_output/memmap')
    parser.add_argument('--output_audio_dir', type=Path,
                        default='./training/example_output/')
    ...
    for split in data_cfg.keys():
        ...
        # setup datasets
        dataset, loader = setup_dataset(split, output_audio_dir)
