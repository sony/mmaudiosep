...
class VGGSound(Dataset):
    ...
    def __init__(
        ...
        *,
        ...
        self.root = Path(root)
        self.audio_output = Path(audio_output)
    ...
    def sample(self, idx: int) -> dict[str, torch.Tensor]:
        ...
        # add audio output directory to make mixture
        audio_dir=self.audio_output
        audio_dir.mkdir(parents=True, exist_ok=True)
        # full-length audio for saving from video
        torchaudio.save(audio_dir / f'{video_id}.flac', audio_chunk.unsqueeze(0), self.sample_rate, format="flac")
